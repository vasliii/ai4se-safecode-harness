...
class ContextBuilder:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            "- pytest is already available in the execution environment.\n"
            "- Do not install pytest before running tests.\n"
            "- Use the run_tests tool to execute the configured pytest command.\n"
            "- Only use run_shell for explicitly allowed diagnostic commands.\n"
